...
export class AppComponent implements OnInit {
  ...
  play() {
    ...
    this.playerService.initialState.take(1).subscribe((res: InitialResponse) => {
      ...
      this.stateWS = new WebSocket(`wss://go-getting-started--dag9oo2.lemonsea-cc6713b3.brazilsouth.azurecontainerapps.io/state-ws?token=${this.token}`);
      ...
      this.advanceWS = new WebSocket(`wss://go-getting-started--dag9oo2.lemonsea-cc6713b3.brazilsouth.azurecontainerapps.io/advance-ws?token=${this.token}`);
